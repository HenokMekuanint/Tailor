...
import 'package:mobile/features/order/presentation/screens/user_order_card_widget.dart';
...
class _UserOrdersPageState extends State<UserOrdersPage> {
  ...
  void initState() {
    ...
    BlocProvider.of<OrderBloc>(context).add(UserGetOrdersEvent());
  }
          ...
          children: [
            ...
            BlocConsumer<OrderBloc, OrderState>(
              ...
              builder: (context, state) {
                if (state is OrderLoadingState || state is OrderInitialState) {
                  return Padding(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return GestureDetector(
                            onTap: () {
                              context.push(
                                  '/${AppRouteNames.userOrderDetailPage}',
