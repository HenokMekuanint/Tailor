...
class TailorAddDropOffDateScreen extends StatefulWidget {
  const TailorAddDropOffDateScreen({super.key});

  @override
  State<TailorAddDropOffDateScreen> createState() =>
      _TailorAddDropOffDateScreenState();
}

class _TailorAddDropOffDateScreenState
    extends State<TailorAddDropOffDateScreen> {
  ...
  void _validateAndSubmit() {
    ...
    final CreateDropOffDateEntity createDropOffDateEntity =
        CreateDropOffDateEntity(dropOffDateTime: dropOffDateTimeRequest);

    BlocProvider.of<DropOffDateBloc>(context).add(CreateDropOffDateEvent(
            ...
            Padding(
              ...
              child: BlocConsumer<DropOffDateBloc, DropOffDateState>(
                listener: (context, state) {
                  if (state is CreateDropOffDateSuccessState) {
                    EasyLoading.showSuccess('Drop Off Date Added successfully',
                        duration: const Duration(seconds: 2),
                        dismissOnTap: true);
